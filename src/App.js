                    ...
                    <div className="app">
                      ...
                      <main className="content">
                        ...
                        <Routes>
                          ...
                          <Route path="/create-company/:companyId" element={<CreateCompany />} />
                          <Route path="/company-list" element={<CompanyList />} />
                          <Route path="/archived-companies" element={<DeletedCompaniesList />} />
                          <Route path="/create-role" element={<CreateRole />} />
                          <Route path="/create-role/:roleId" element={<CreateRole />} />
                          <Route path="/role-list" element={<RoleList />} />
                          <Route path="/archived-roles" element={<DeletedRolesList />} />
